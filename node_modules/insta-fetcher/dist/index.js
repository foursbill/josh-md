...
class igApi {
    ...
    constructor(IgCookie = '', AxiosOpts = {}) {
        ...
        this._getReels = (ids) => __awaiter(this, void 0, void 0, function* () {
            ...
            const graphql = res === null || res === void 0 ? void 0 : res.data;
            let result = graphql.data.reels_media[0].items.map((item) => (Object.assign({ owner: graphql.data.reels_media[0].owner, media_id: item.id, mimetype: item.is_video ? 'video/mp4' || 'video/gif' : 'image/jpeg', taken_at: item.taken_at_timestamp, type: item.is_video ? 'video' : 'image', url: item.is_video ? item.video_resources[0].src : item.display_url, dimensions: item.dimensions }, graphql)));
            return result;
        });
        /**
